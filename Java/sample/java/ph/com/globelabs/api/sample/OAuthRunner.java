...
public class OAuthRunner {
    ...
    public static void main(String[] args) throws GlobeApiException {
        ...
        System.out.println(oauth.getLoginUrl(appId));
        ...
        System.out.println(oauth.getAccessToken(appId, appSecret, code));
        ...
        System.out.println(oauth.getAccessToken(requestURL));
    }
